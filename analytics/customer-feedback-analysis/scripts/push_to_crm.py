#!/usr/bin/env python3
"""Push customer-feedback-analysis records to CRM via agentic-app API.

Reads JSON from stdin, routes to the appropriate CRM adapter,
and POSTs each record to CRM_URL/api/push.

Source tag: skill:customer-feedback-analysis:v2.1.0
"""
...
SKILL_NAME = "customer-feedback-analysis"
SKILL_VERSION = "2.1.0"
