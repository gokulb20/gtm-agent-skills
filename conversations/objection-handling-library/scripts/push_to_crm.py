#!/usr/bin/env python3
"""Push objection-handling-library records to CRM via agentic-app API.

Reads JSON from stdin, routes to the appropriate CRM adapter,
and POSTs each record to CRM_URL/api/push.

Source tag: skill:objection-handling-library:v2.1.0
"""
...
SKILL_NAME = "objection-handling-library"
SKILL_VERSION = "2.1.0"
